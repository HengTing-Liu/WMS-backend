...
import com.abtk.product.dao.entity.SysConfig;
import com.abtk.product.dao.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements ISysConfigService
{
    ...
    public void deleteConfigByIds(Long[] configIds)
    {
        for (Long configId : configIds)
        {
            ...
            {
                throw new ServiceException(i18nService.getMessage("config.builtin.not.delete", config.getConfigKey()));
            }

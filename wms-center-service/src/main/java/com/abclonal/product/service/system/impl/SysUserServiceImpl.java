...
import com.abclonal.product.common.utils.bean.BeanValidators;

import com.abclonal.product.dao.entity.*;
import com.abclonal.product.dao.mapper.*;
...
public class SysUserServiceImpl implements ISysUserService
{
    ...
    public void checkUserAllowed(SysUser user)
    {
        ...
        {
            throw new ServiceException(i18nService.getMessage("user.admin.not.allowed"));
        }
    }
    ...
    public void checkUserDataScope(Long userId)
    {
        if (!SysUser.isAdmin(SecurityUtils.getUserId()))
        {
            ...
            {
                throw new ServiceException(i18nService.getMessage("permission.user.access.denied"));
            }
        }
    }
    ...
    public String importUser(List<SysUser> userList, Boolean isUpdateSupport, String operName)
    {
        ...
        {
            throw new ServiceException(i18nService.getMessage("user.import.empty"));
        }
        int successNum = 0;
        int failureNum = 0;

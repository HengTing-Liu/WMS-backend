...
/**
 * (InvQrcodedetail)表服务接口
 *
 * @author lht
 * @since 2026-03-04 11:31:16
 */
public interface InvQrcodedetailService {
     ...
     * @return 对象列表
     */
    List<InvQrcodedetail> queryByCondition(InvQrcodedetail invQrcodedetail);
     ...
     * @return 实例对象
     */
    InvQrcodedetail insert(InvQrcodedetail invQrcodedetail);
    /**
     * 新增单条数据
     *
     * @param  entities 实例对象
     * @return 实例对象
     */
    int insertBatchAtomic(List<InvQrcodedetail> entities);
     ...
     * @return 影响行数
     */
    int insertOrUpdateBatch(List<InvQrcodedetail> entities);
     ...
     * @return 实例对象
     */
    int updateBatchAtomic(List<InvQrcodedetail> list);

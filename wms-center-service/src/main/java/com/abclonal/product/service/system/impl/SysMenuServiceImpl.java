...
import com.abclonal.product.dao.mapper.SysMenuMapper;
import com.abclonal.product.dao.mapper.SysRoleMapper;
import com.abclonal.product.dao.mapper.SysRoleMenuMapper;
import com.abclonal.product.service.domain.vo.MetaVo;
import com.abclonal.product.service.domain.vo.RouterVo;
...
import com.abclonal.product.service.system.converter.MenuConverter;
import com.abclonal.product.service.system.converter.RouteItem;
...
public class SysMenuServiceImpl implements ISysMenuService
{
    ...
    {
        // 返回所有与该角色关联的菜单ID，不做过滤
        // 前端会根据 menuCheckStrictly 自行处理父子联动显示逻辑
    ...
    public List<RouteItem> buildMenus2(List<SysMenu> menus) {
        return MenuConverter.convertToRouteItems(menus);
    }
    ...
    {
        return menuMapper.updateMenuStatus(menu);
    }
    ...
    {
        return menuMapper.updateMenuVisible(menu);
    }
    ...
    {
        List<SysMenu> allMenus = menuMapper.selectPermissionTreeAll();
    ...
    {
        if (menu == null || !"F".equals(menu.getMenuType()))
        {
            return true;
        }
        return menuMapper.checkPermsUnique(menu.getPerms(), menu.getMenuId() == null ? 0 : menu.getMenuId()) == 0;
    }

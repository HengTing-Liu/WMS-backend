package com.abclonal.product.biz.location;

import com.abclonal.product.api.domain.request.location.GridPositionRequest;
import com.abclonal.product.api.domain.request.location.WmsLocationBatchCreateRequest;
import com.abclonal.product.api.domain.request.location.WmsLocationBatchRequest;
import com.abclonal.product.api.domain.request.location.WmsLocationGridUpdateRequest;
import com.abclonal.product.api.domain.request.location.WmsLocationRequest;
import com.abclonal.product.api.domain.request.location.WmsLocationTreeRequest;

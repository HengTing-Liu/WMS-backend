...
import com.abclonal.product.domain.converter.UserConverter;
...
import com.abclonal.product.service.system.*;
...
public class SysUserBiz extends AbstractBiz {
     ...
     * @return: com.abclonal.product.common.domain.R<java.lang.Long>
     * @author: zpy
     ...
     * @return: com.abclonal.product.common.domain.R<java.lang.Boolean>
     * @author: zpy
     ...
     * @param userIds
     * @description: 批量删除
     * @return: com.abclonal.product.common.domain.R<java.lang.String>
     * @author: zpy

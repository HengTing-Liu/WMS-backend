...
import com.abtk.product.service.system.service.SysEnumDefineService;
import com.abtk.product.service.system.service.SysEnumItemService;
import com.abtk.product.domain.converter.SysEnumDefineConverter;
import com.abtk.product.domain.converter.SysEnumDefineComplexConverter;
...
import com.abtk.product.api.domain.request.sys.SysEnumDefineRequest;
import com.abtk.product.api.domain.request.sys.SysEnumDefineBatchRequest;
import com.abtk.product.api.domain.request.sys.SysEnumDefineWithItemsRequest;
import com.abtk.product.api.domain.response.sys.SysEnumDefineResponse;
import com.abtk.product.api.domain.response.sys.SysEnumDefineWithItemsResponse;

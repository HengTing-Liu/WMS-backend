...
/**
 * 公司数据权限对象 company_data_permission
 *
 * @author backend1
 */
@Schema(description = "公司数据权限")
public class CompanyDataPermission extends BaseEntity {
     ...
     */
    @Schema(description = "数据权限范围", allowableValues = {"ALL", "CUSTOM", "DEPT", "DEPT_AND_CHILD", "SELF"}, defaultValue = "COMPANY")

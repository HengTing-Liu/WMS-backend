...
/**
 * 领用提货单主表(IoPickOrderConsume)实体类
 *
 * @author wms
 * @since 2026-04-03
 */
@Data
public class IoPickOrderConsume extends BaseEntity {
    ...
    @Excel(name = "领用单号", type = Type.ALL)
    @Schema(description = "领用单号")
    private String consumeNo;

    @Excel(name = "领用公司编码", type = Type.ALL)
    @Schema(description = "领用公司编码")
    private String outCompanyCode;

    @Excel(name = "领用仓库编码", type = Type.ALL)
    @Schema(description = "领用仓库编码")

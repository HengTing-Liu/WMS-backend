 ...
 *
 * -- 多字段拼接（WMS-LOWCODE-LOOKUP-CONCAT）
 * SELECT m.*,
...
public class LookupColumn {
    ...
    /** 多字段拼接固定分隔符（WMS-LOWCODE-LOOKUP-CONCAT）。 */
     ...
     * <ul>
     *   <li>单字段：size == 1</li>
     *   <li>多字段拼接：size &gt; 1，按顺序拼接，分隔符 {@link #CONCAT_SEPARATOR}</li>
     * </ul>
    ...
    public String getSqlExpression() {
        ...
        if (targetFields == null || targetFields.isEmpty()) {
            ...
            sb.append("CONCAT_WS('").append(CONCAT_SEPARATOR).append("'");
